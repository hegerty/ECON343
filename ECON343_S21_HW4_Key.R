...
data<-read.csv("https://raw.githubusercontent.com/hegerty/ECON343/main/ECON343_S21_HW4_Data.csv")
...
nomrdiff<-ts(nomrdiff,end=c(2020,12),frequency = 12)
realrdiff<-realrmx-realrus
realrdiff<-ts(realrdiff,end=c(2020,12),frequency = 12)
