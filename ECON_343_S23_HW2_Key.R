...
data<-read.csv("https://raw.githubusercontent.com/hegerty/ECON343/main/ECON343_S23_HW2_Data.csv")
# setwd("D:/Teaching Spring 2023/343")
# data<-read.csv("ECON343_S23_HW2_Data.csv")
head(data)
tail(data)

## Q1
## 1960q1-2022q4, quarterly
...
tsdata<-ts(tsdata,start=c(1960,1),freq=4)
...
lastdigit<-c(0:9,"full")

##Choose the start and endpoints
## Here I already matched the appropriate points
start<-c(1,1,1,1,5,5,5,9,9,9,1)
end<-c(244,244,248,252,244,248,252,244,248,252,252)
...
for(i in 1:length(start)){
  ...
  print(noquote("This correlation is negative and somewhat significant."))
}
